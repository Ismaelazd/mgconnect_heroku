...
<body class="clean-body" style="margin: 100px 0 0 0; padding: 0; -webkit-text-size-adjust: 100%; background-color: #f0f2f3;">
                                            ...
                                            <div
                                                ...
                                                <div
                                                    ...
                                                    <p
                                                        ...
                                                        <span style="font-size: 24px;">Nouveau message de :</span></p>
                                                </div>
                                            </div>
                                            ...
                                            <div
                                                ...
                                                <div
                                                    ...
                                                    <p
                                                        ...
                                                        <span style="font-size: 16px;">Nom complet : {{$formulaire->name}} {{$formulaire->firstname}}</span></p>
                                                    <p
                                                        style="font-size: 16px; line-height: 1.5; word-break: break-word; text-align: left; mso-line-height-alt: 24px; margin: 0;">
                                                        <span style="font-size: 16px;">Email : {{$formulaire->email}}</span></p>
                                                </div>
                                            </div>
                                            <!--[if mso]></td></tr></table><![endif]-->
                                            ...
                                            <div
                                                ...
                                                <div
                                                    ...
                                                    <p
                                                        ...
                                                        <span style="font-size: 18px;"><strong>Message reçu :</strong></span></p>
                                                </div>
                                            </div>
                                            <!--[if mso]></td></tr></table><![endif]-->
                                            <!--[if mso]><table width="100%" cellpadding="0" cellspacing="0" border="0"><tr><td style="padding-right: 30px; padding-left: 30px; padding-top: 0px; padding-bottom: 0px; font-family: Tahoma, Verdana, sans-serif"><![endif]-->
